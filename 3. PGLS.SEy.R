...
pcnm_axes <- pcnm[,c(31, 5, 2, 7)]
env_axes <- env[,c(3,2)]

### Phylogeny
tree<-read.tree("Datasets/trees/AVGLOCSEX_Lima.tre")
rownames(data) <- data$sp_ives
name.check(tree,setNames(data$LogCS,rownames(data)))
plot(tree, cex = 0.5)
axisPhylo()
...
fit.allo <- pgls.SEy(y ~ LogCS, data=data,tree=tree, corClass = corPagel)
summary(fit.allo)

fit<-pgls.SEy(LogCS~bio1,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio2,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~bio3,data=data,tree=tree)
summary(fit)#

fit<-pgls.SEy(LogCS~bio4,data=data,tree=tree)
summary(fit)#

fit<-pgls.SEy(LogCS~bio5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio6,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio7,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio8,data=data,tree=tree)
summary(fit) #

fit<-pgls.SEy(LogCS~bio9,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio10,data=data,tree=tree)
summary(fit)#####

fit<-pgls.SEy(LogCS~bio11,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio12,data=data,tree=tree)
summary(fit) ##

fit<-pgls.SEy(LogCS~bio13,data=data,tree=tree)
summary(fit) #

fit<-pgls.SEy(LogCS~bio14,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio15,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio16,data=data,tree=tree)
summary(fit) #

fit<-pgls.SEy(LogCS~bio17,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio18,data=data,tree=tree)
summary(fit) #

fit<-pgls.SEy(LogCS~bio19,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~humid,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~npp,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~soilmoist,data=data,tree=tree)
summary(fit) #

##repeat model with filters

fit<-pgls.SEy(LogCS~bio1+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio2+pcnm1+pcnm5,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~bio3+pcnm1+pcnm5,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~bio4+pcnm1+pcnm5,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~bio5+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio6+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio7+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio8+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio9+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio10+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)#

fit<-pgls.SEy(LogCS~bio11+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio12+pcnm1+pcnm5,data=data,tree=tree)
summary(fit) ##

fit<-pgls.SEy(LogCS~bio13+pcnm1+pcnm5,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~bio14+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio15+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio16+pcnm1+pcnm5,data=data,tree=tree)
summary(fit) 

fit<-pgls.SEy(LogCS~bio17+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~bio18+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)#

fit<-pgls.SEy(LogCS~bio19+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~npp+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~humid+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(LogCS~soilmoist+pcnm1+pcnm5,data=data,tree=tree)
summary(fit)
...
fit<-pgls.SEy(LogCS~bio1,data=data,tree=tree, corClass=corPagel)
summary(fit)
fit<-pgls.SEy(LogCS~bio2,data=data,tree=tree, corClass=corPagel)
summary(fit)
fit<-pgls.SEy(LogCS~bio3,data=data,tree=tree, corClass=corPagel)
summary(fit) 
fit<-pgls.SEy(LogCS~bio4,data=data,tree=tree, corClass=corPagel)
summary(fit) #
fit<-pgls.SEy(LogCS~bio5,data=data,tree=tree, corClass=corPagel)
summary(fit) 
fit<-pgls.SEy(LogCS~bio6,data=data,tree=tree, corClass=corPagel)
summary(fit)
fit<-pgls.SEy(LogCS~bio7,data=data,tree=tree, corClass=corPagel) 
summary(fit) 
fit<-pgls.SEy(LogCS~bio8,data=data,tree=tree, corClass=corPagel)
summary(fit) 
fit<-pgls.SEy(LogCS~bio9,data=data,tree=tree, corClass=corPagel)
summary(fit) 
fit<-pgls.SEy(LogCS~bio10,data=data,tree=tree, corClass=corPagel)
summary(fit) ##
fit<-pgls.SEy(LogCS~bio11,data=data,tree=tree, corClass=corPagel)
summary(fit)
fit<-pgls.SEy(LogCS~bio12,data=data,tree=tree, corClass=corPagel)
summary(fit) ##
fit<-pgls.SEy(LogCS~bio13,data=data,tree=tree, corClass=corPagel)
summary(fit) #
fit<-pgls.SEy(LogCS~bio14,data=data,tree=tree, corClass=corPagel)
summary(fit) #
fit<-pgls.SEy(LogCS~bio15,data=data,tree=tree, corClass=corPagel)
summary(fit)
fit<-pgls.SEy(LogCS~bio16,data=data,tree=tree, corClass=corPagel)
summary(fit) ##
fit<-pgls.SEy(LogCS~bio17,data=data,tree=tree, corClass=corPagel)
summary(fit) ##
fit<-pgls.SEy(LogCS~bio18,data=data,tree=tree, corClass=corPagel)
summary(fit) ##
fit<-pgls.SEy(LogCS~bio19,data=data,tree=tree, corClass=corPagel)
summary(fit) 
fit<-pgls.SEy(LogCS~npp,data=data,tree=tree, corClass=corPagel)
summary(fit)
fit<-pgls.SEy(LogCS~humid,data=data,tree=tree, corClass=corPagel)
summary(fit) #
fit<-pgls.SEy(LogCS~soilmoist,data=data,tree=tree, corClass=corPagel)
summary(fit) #.

### 4 mais importantes (decrescente): bio12 > bio16 > bio17 > bio10 > bio18 > bio4

fit<-pgls.SEy(LogCS~bio1+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio2+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(LogCS~bio3+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(LogCS~bio4+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(LogCS~bio5+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio6+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio7+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio8+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio9+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)#######

fit<-pgls.SEy(LogCS~bio10+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio11+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~bio12+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) #########

fit<-pgls.SEy(LogCS~bio13+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(LogCS~bio14+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(LogCS~bio15+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)##### error

fit<-pgls.SEy(LogCS~bio16+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(LogCS~bio17+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)#

fit<-pgls.SEy(LogCS~bio18+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)#

fit<-pgls.SEy(LogCS~bio19+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~npp+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit) ############## FALSE CONVERGENCE

fit<-pgls.SEy(LogCS~humid+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(LogCS~soilmoist+pcnm1+pcnm5,data=data,tree=tree, corClass=corPagel)
summary(fit)
...
LogCS <- as.numeric(data$LogCS)

rownames(bio_data) <-data$sp_ives
names(LogCS) <-data$sp_ives
...
fitBM <- pgls.SEy(LogCS ~ bio12 + pcnm1 + pcnm5, data = data, tree = tree, corClass = corBrownian)
summary(fitBM)

fitPG <- pgls.SEy(LogCS ~ bio12 + pcnm1 + pcnm5, data = data, tree = tree, corClass = corPagel)
summary(fitPG)
...
p_bio <- ggplot(data, aes(x = bio18 + pcnm1 + pcnm5, y = LogCS, color = fac)) +
  geom_point(size = 7) +
  ...
  labs(x = "Precipitation in the warmest quarter (BIO18) + PCNM", y = "Mandibular size (logCS)",
       title = "Relationship between LogCS and Bioclimatic Variables with PGLS",
...
fit<-pgls.SEy(shape.2d~bio1+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio2+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) ## False convergence

fit<-pgls.SEy(shape.2d~bio3+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(shape.2d~bio4+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(shape.2d~bio5+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio6+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) # False convergence

fit<-pgls.SEy(shape.2d~bio7+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) #######

fit<-pgls.SEy(shape.2d~bio8+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio9+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio10+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree)
summary(fit)

fit<-pgls.SEy(shape.2d~bio11+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio12+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio13+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(shape.2d~bio14+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) ### False convergence

fit<-pgls.SEy(shape.2d~bio15+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio16+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) 

fit<-pgls.SEy(shape.2d~bio17+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio18+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~bio19+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit) #####

fit<-pgls.SEy(shape.2d~npp+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~humid+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)

fit<-pgls.SEy(shape.2d~soilmoist+pcnm31+pcnm5+pcnm2+pcnm7,data=data,tree=tree, corClass=corPagel)
summary(fit)
...
fit_bio1 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio1 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio1)

fit_bio2 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio2 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio2)

fit_bio3 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio3 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio3)

fit_bio4 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio4 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio4)

fit_bio5 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio5 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio5)

fit_bio6 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio6 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio6)

fit_bio7 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio7 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio7)

fit_bio8 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio8 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio8)

fit_bio9 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio9 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio9)

fit_bio10 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio10 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio10)

fit_bio11 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio11 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio11)

fit_bio12 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio12 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio12)

fit_bio13 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio13 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio13)

fit_bio14 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio14 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio14)

fit_bio15 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio15 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio15)

fit_bio16 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio16 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio16)

fit_bio17 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio17 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio17)

fit_bio18 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio18 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio18)

fit_bio19 <- procD.pgls(gpa$coords ~ log(gpa$Csize) + bio19 + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_bio19)

fit_npp <- procD.pgls(gpa$coords ~ log(gpa$Csize) + npp + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_npp)

fit_humid <- procD.pgls(gpa$coords ~ log(gpa$Csize) + humid + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
summary(fit_humid)

fit_soilmoist <- procD.pgls(gpa$coords ~ log(gpa$Csize) + soilmoist + pcnm31 + pcnm5 + pcnm2 + pcnm7, phy = tree, data = data)
...
fitBM <- pgls.SEy(LogCS ~ bio7 + bio19 + pcnm1 + pcnm5, data = data, tree = tree, corClass = corBrownian)
summary(fitBM)

fitPG <- pgls.SEy(LogCS ~ bio7 + bio19 + pcnm1 + pcnm5, data = data, tree = tree, corClass = corPagel)
summary(fitPG)
...
fit<-pgls.SEy(LogCS ~ bio7 + bio19 + pcnm1 + pcnm5, data = data, tree = tree, corClass = corPagel)
coef(fit)
summary(fit) 
res <- resid(fit, type="n") 
qqnorm(res) 
